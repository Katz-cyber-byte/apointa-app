...
const Privacy = () => (
    <div className="min-h-screen bg-white p-8 md:p-20 font-sans text-slate-800 leading-relaxed max-w-4xl mx-auto">
        ...
        <p className="mb-4">Schedinary is committed to protecting your personal information in accordance with the Protection of Personal Information Act (POPIA).</p>
        ...
        <section className="space-y-6">
            ...
            <div>
                ...
                <p>Users may request the deletion of their personal data at any time by contacting the business owner or Schedinary support.</p>
            </div>
        </section>
    </div>
);
